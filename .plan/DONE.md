...
- 2025-11-06 **API-SCHEMA-UNIFY** — Inkonsistente Felder in Antworten _commit:7ba7f46_
- 2025-11-06 **SHUTDOWN-CLEANUP** — `CancelledError` bei Ctrl-C nach SSE _commit:44b649c_
- 2025-11-06 **STATE-FLAGS-CLARIFY** — Readiness besser exponieren _commit:ed073fd_
...
- 2025-11-09 **D.5** — Unified error schema + enums (structured envelope, docs, tests) _commit:bafb7d4_
- 2025-11-10 **T-202511-018** — Sync roadmap + plan docs with audit (ROADMAP.md, .plan statuses, overview snapshot) _commit:401e453_
- 2025-11-10 **D.3** — Unify search metadata (range query/has_more parity) _commit:d46412d_
- 2025-11-10 **D.4** — POST /api/collect.json multi-query collector (per-subop envelopes, docs, tests) _commit:0545ca4_
- 2025-11-10 **D.6** — Server-side result budgeting (collector auto-trim/strict enforcement, docs/tests) _commit:0545ca4_
