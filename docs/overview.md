...
- **In progress**: search metadata unification still needs `{query,has_more}` coverage for `list_functions_in_range`; compact listings continue to expose offset-based slicing.
