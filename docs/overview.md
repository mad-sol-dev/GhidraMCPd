...
- **Queued backlog**: {R.2} enhanced ranking/context windows, {R.3} `include_literals` plumbing, {R.4} expanded write/rebase/datatypes audit logging, {R.5} CORS/origin whitelists, {R.6} Docker/CI packaging, {R.7} MCP tool UX docs — see `.plan/TODO.md` for bucketed priority.
