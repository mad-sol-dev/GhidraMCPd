...
_REQUEST_SCHEMA_MAP = {
    ...
    "/api/select_program.json": "select_program.request.v1.json",
    "/api/project_rebase.json": "project_rebase.request.v1.json",
    "/api/read_bytes.json": "read_bytes.request.v1.json",
    "/api/write_bytes.json": "write_bytes.request.v1.json",
...
_RESPONSE_SCHEMA_MAP = {
    ...
    "/api/current_program.json": "current_program.v1.json",
    "/api/select_program.json": "current_program.v1.json",
    "/api/read_bytes.json": "read_bytes.v1.json",
    "/api/write_bytes.json": "write_bytes.v1.json",
